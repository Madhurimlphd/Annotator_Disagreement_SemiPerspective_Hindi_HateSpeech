...
D] The HH-LEX lexicon used in this study is available on Zenodo.

* Link for lexicon specific to HASOC Hindi 2019 dataset: https://zenodo.org/records/17938022
...
E] The detailed workflow of the code utilised in the experimented is documented in the file Code_Structure. The code for FI-RC framework is implemented in the Final_subcategories_SW_spearman29.ipynb

F] A detailed description of the lexicon is provided in the preprint linked: https://assets-eu.researchsquare.com/files/rs-9236082/v1_covered_05423bc5-88a9-478e-98a0-7c05e4e71e84.pdf
